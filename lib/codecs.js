...
const bm25IndexCodec = {
  preencode(state, value) {
    ...
    c.float32.preencode(state, value.k1)
    c.float32.preencode(state, value.b)
    c.float32.preencode(state, value.avgLength)
  ...
  encode(state, value) {
    ...
    c.float32.encode(state, value.k1)
    c.float32.encode(state, value.b)
    c.float32.encode(state, value.avgLength)
  ...
  decode(state) {
    ...
    const k1 = c.float32.decode(state)
    const b = c.float32.decode(state)
    const avgLength = c.float32.decode(state)
